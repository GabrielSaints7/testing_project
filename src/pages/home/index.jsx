...
import bannerImage from '../../assets/banners/banner-testing.png'
    ...
    return (<>
        ...
        <Container>
            <div>
                ...
                <Button title="O que é" variant="primary" onClick={handleClickSignIn}/>
                <Button title="Documentação" variant="tercenary" onClick={handleClickSignIn}/>
            </div>
            <div>
